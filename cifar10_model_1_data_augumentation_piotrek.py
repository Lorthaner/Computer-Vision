# -*- coding: utf-8 -*-
"""CIFAR10_model_1_Data_augumentation_Piotrek.ipynb
...
writer = SummaryWriter('runs/CIFAR10_model_experiment')
# %load_ext tensorboard

device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu')

trainset = torchvision.datasets.CIFAR10(root = './sample_data', train = True, download = True, transform = transforms.Compose([transforms.RandomHorizontalFlip(),
                                                                                                                               transforms.ToTensor(),
